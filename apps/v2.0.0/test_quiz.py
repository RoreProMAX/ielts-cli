...
class QuizTests(unittest.TestCase):
    ...
    def test_content_has_twenty_matching_words_and_unique_blanks(self):
        ...
        for item in payload["items"]:
            ...
            question = self.factory().make(item["word"], "collocation")
    ...
    def test_scheduler_order_is_independent_of_question_answers(self):
        ...
        self.assertEqual(choose_mode(recall_familiar), "listening")
