...
- `launcher.py` selects the application version. The current version is `apps/v3.3.0`; `apps/v1.0.0`, `apps/v2.0.0`, and `apps/v3.2.0` are retained for version isolation.
